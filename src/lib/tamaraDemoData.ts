...
export const TAMARA_VISITS = [
  {
    ...
    status: 'approved' as const, purchase_amount: 702.24, scheduled_date: visitDate(7),
  ...
  },
  {
    ...
    status: 'approved' as const, purchase_amount: 601.37, scheduled_date: visitDate(7),
    started_at: daysAgo(7), submitted_at: daysAgo(7),
  ...
  },
  {
    ...
    status: 'approved' as const, purchase_amount: 695.86, scheduled_date: visitDate(6),
  ...
  },
  {
    ...
    status: 'approved' as const, purchase_amount: 206.84, scheduled_date: visitDate(6),
    started_at: daysAgo(6), submitted_at: daysAgo(6),
  ...
  },
  {
    ...
    status: 'approved' as const, purchase_amount: 1067.40, scheduled_date: visitDate(5),
  ...
  },
  {
    ...
    status: 'approved' as const, purchase_amount: 1212.96, scheduled_date: visitDate(5),
    started_at: daysAgo(5), submitted_at: daysAgo(5),
  ...
  },
  {
    ...
    status: 'approved' as const, purchase_amount: 651.17, scheduled_date: visitDate(4),
  ...
  },
  {
    ...
    status: 'approved' as const, purchase_amount: 842.69, scheduled_date: visitDate(4),
    started_at: daysAgo(4), submitted_at: daysAgo(4),
